...
export const createFhevmInstance = async (parameters: {
  ...
  const config: FhevmInstanceConfig = {
    ...
    // SDK expects structured key/params types; store returns strings. Cast here to satisfy TS.
    publicKey: pub.publicKey as unknown as FhevmInstanceConfig["publicKey"],
    publicParams: pub.publicParams as unknown as FhevmInstanceConfig["publicParams"],
  };
